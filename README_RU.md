...
Плагин для Claude Code — пайплайн AI-разработки из 7 команд с автоматическим критиком (senior engineer) на двух стадиях, системой накопления уроков, памятью Serena для стабильных знаний о проекте и гейтом визуальной верификации через Playwright MCP — всего 6 слоёв контекста.
