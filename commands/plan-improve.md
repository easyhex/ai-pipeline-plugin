...
In every Master Plan file modified (`architecture.md`, `features.md`, `roadmap.md`, `risks.md`): bump `doc_version` by 1, set `last_changed`, and append a `## Change history` row (date | version | one-line change | critic report path).
